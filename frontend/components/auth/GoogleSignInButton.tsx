...
export default function GoogleSignInButton() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <button onClick={handleClick} disabled={loading} className={`w-full flex items-center justify-center gap-3 border font-medium py-3 px-4 rounded-xl transition-colors disabled:opacity-60 ${
        isDark
          ? "bg-[#1a1a1a] border-[#2a2a2a] text-white hover:bg-[#222]"
          : "bg-white border-[#FFDDD2] text-[#1A1A1A] hover:bg-[#FFF5F0]"
      }`}>
